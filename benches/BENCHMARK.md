...
| ------------- | --------------- | ----------------- | ------------ | -------------- |
| ping | 🟩 **11** | 🟥 229 (+218) | 🟩 **11** | 🟩 **11** |
| log | 🟩 117 (+1) | 🟥 333 (+217) | 🟩 117 (+1) | 🟩 **116** |
| create_account | 🟩 1575 (+23) | 🟥 3759 (+2207) | 🟩 1587 (+35) | 🟩 **1552** |
| transfer | 🟩 **1290** | 🟨 2444 (+1154) | 🟩 1301 (+11) | 🟩 1316 (+26) |
...
| ------------------- | --------------- | ------------------- | -------- | -------------- |
| Binary size (bytes) | 🟩 18688 (+3936) | 🟥 208520 (+193768) | 🟩 **14752** | 🟥 114632 (+99880) |
